...
Mivel az \textbf{ECMAScript} standard nem tartalmaz input/output (I/O), azaz bemenet/ kiemenet funkciókat, így a hálózati, tárolási és grafikus elemek megvalósításához böngészőre, vagy más futtatási környezetre van szükség.\cite{javascript} 
